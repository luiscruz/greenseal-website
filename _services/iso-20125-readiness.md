---
title: "ISO/IEC TS 20125 Readiness"
date: 2026-06-25T00:00:00+00:00
weight: 6
summary: |
 **Readiness for the new digital-services ecodesign specification.**

 Hands-on support for [ISO/IEC TS 20125-1:2026](https://www.iso.org/standard/86105.html), the newly published ISO/IEC Technical Specification for digital services ecodesign, covering its six life-cycle stages.

 - Gap assessment against the standard's ecopractices
 - Environmental budgets and indicators per life-cycle stage
 - Support drafting your conformance disclosure
 - Team training on the standard's requirements
---

[ISO/IEC TS 20125-1:2026](https://www.iso.org/standard/86105.html), *"Information technology — Digital services ecodesign — Part 1: Ecopractices for life cycle stages,"* is an ISO/IEC Technical Specification published in February 2026 by ISO/IEC JTC 1/SC 39/WG 4. It sets out requirements and recommendations for reducing the environmental impact of digital services across six life-cycle stages — requirements gathering, design, implementation, operations, maintenance, and end of life — through roughly two dozen "ecopractices," each with concrete requirements, recommendations, and indicators.
...
ISO/IEC TS 20125 works at the level of a specific digital service: does *this* service follow recognised ecodesign practices at each life-cycle stage? Our [GSP™ certification](/gsp/) works one level up, at the organisation: does the team building it have the measurement infrastructure and improvement culture to keep meeting standards like this one over time, not just once. The two are complementary — see our post on [RGESN and GSP™](/blog/2026-03-03-rgesn-and-gsp/) for the fuller argument, which applies equally here.

👉 **[Talk to us about ISO/IEC TS 20125 readiness](/contact/)**
